...
export interface IStudentProfile extends IUser, mongoose.Document {}
...
const StudentSchema = new Schema<IStudentProfile>({
...
const StudentModel = mongoose.model<IStudentProfile & Document>('Student', StudentSchema);
